...
public class CcscoinMainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public CcscoinMainNetParams() {
        super();
        interval = INTERVAL; //TODO
        targetTimespan = TARGET_TIMESPAN; //TODO
        maxTarget = Utils.decodeCompactBits(0x1d00ffffL);
        dumpedPrivateKeyHeader = 33;
        addressHeader = 28; // chainparams.cpp, line 173
        p2shHeader = 50;
        acceptableAddressCodes = new int[] { addressHeader, p2shHeader };
        port = 5888;
        packetMagic = 0xbf0c6bbd; //TODO
        ...
        checkpoints.put(0, Sha256Hash.wrap("0000da969e2b14a964ea496e122b304fcc636b6c7f6301c32327fc8b4a84675c"));
        checkpoints.put(5000, Sha256Hash.wrap("00003d201e490478a27435cffac1f4f0ddf30b63b39bd6a9e66eb3e454f7c286"));
    ...
    private static CcscoinMainNetParams instance;
    public static synchronized CcscoinMainNetParams get() {
        if (instance == null) {
            instance = new CcscoinMainNetParams();
        }
        return instance;
    }
